...
%       varsToPlot = [P_ATMNucPhos P_P53NucPhos P_MDM2Nuc P_WIP1Nuc];
	...
	function xd=f(t,x)
		...
		% Mdm2 TODO change this include ARF for v3
		xd(P_MDM2Nuc)=-barpm*Vr*(x(P_MDM2Nuc)-x(P_MDM2Cyto))-bardeltam*x(P_MDM2Nuc)-c_MDM2Nuc1*...
            x(P_ARF) * (x(P_MDM2Nuc)/(c_MDM2Nuc2+x(P_MDM2Nuc)));
		% Mdm2 mRNA
