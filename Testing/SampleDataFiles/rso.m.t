...
s1 =$gauss(0.1,0.1),name=Gs1$;        % Wip1 mRNA synthesis
s2 = 0.03+$gauss(0,0.01),name=Gs2$;       % PTEN mRNA synthesis
s3 = $gauss(0.1,0.1),name=Gs3$;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = $gauss(0.1,0.015),name=Gs5$;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +$gauss(0,0.01),name=Gt2$;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = $gauss(0.1,0.02),name=Gt4$;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
...
p4  = 1e-10+$gauss(0,1e-11),name=Gp4$;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+$gauss(0,2e-5),name=Gd10$;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+$gauss(0,75),name=Gd12$;       % Rb1 dephosphorylation
...
b4 = 1e-5+$gauss(0,1e-6),name=Gb4$;       % Rb1 and E2F1
