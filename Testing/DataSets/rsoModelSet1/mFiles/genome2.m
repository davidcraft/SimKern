...
s1 =0.2623134972520159;        % Wip1 mRNA synthesis
s2 = 0.03+0.006072418965878864;       % PTEN mRNA synthesis
s3 = 0.039474913154278125;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.10325933531526456;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.002156235684106005;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.122067334939143;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+57.693895824666825;        % p53 sythesis
...
p4  = 1e-10+-1.3967659964078738e-11;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+9.438771920743854e-06;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+62.587760480325066;       % Rb1 dephosphorylation
...
b4 = 1e-5+-5.656222806574076e-07;       % Rb1 and E2F1
