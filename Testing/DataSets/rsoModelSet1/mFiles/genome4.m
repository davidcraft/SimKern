...
s1 =0.1525556842435314;        % Wip1 mRNA synthesis
s2 = 0.03+0.011821745846399426;       % PTEN mRNA synthesis
s3 = -0.03492634290221944;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.08399066434526098;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.007929484760310334;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.12488055035149044;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-32.63331414978604;        % p53 sythesis
...
p4  = 1e-10+-4.759215573927068e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+3.595007975923568e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+186.94681936094898;       % Rb1 dephosphorylation
...
b4 = 1e-5+-1.867173299929956e-07;       % Rb1 and E2F1
