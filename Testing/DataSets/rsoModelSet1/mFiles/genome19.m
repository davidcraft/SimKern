...
s1 =0.1845094529536816;        % Wip1 mRNA synthesis
s2 = 0.03+-0.004771119566930777;       % PTEN mRNA synthesis
s3 = 0.19627393983134256;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.10166806981732998;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +0.012238810346142302;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.11363695513145866;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-21.46014797354427;        % p53 sythesis
...
p4  = 1e-10+7.555622872813401e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+-1.3155055375242457e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+-8.091071849119546;       % Rb1 dephosphorylation
...
b4 = 1e-5+1.4161270507509012e-06;       % Rb1 and E2F1
