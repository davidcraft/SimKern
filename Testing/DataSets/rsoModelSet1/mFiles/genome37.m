...
s1 =-0.011338261671738722;        % Wip1 mRNA synthesis
s2 = 0.03+0.01307051329725137;       % PTEN mRNA synthesis
s3 = 0.17991294419504317;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.10065627013884591;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.0008609623377829933;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.06235896704246711;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+26.09927751080326;        % p53 sythesis
...
p4  = 1e-10+1.6224534873857377e-11;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+-1.3999504321284292e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+-54.02908890438077;       % Rb1 dephosphorylation
...
b4 = 1e-5+1.4381565117700588e-06;       % Rb1 and E2F1
