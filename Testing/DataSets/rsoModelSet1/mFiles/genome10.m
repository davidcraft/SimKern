...
s1 =0.14289733910359292;        % Wip1 mRNA synthesis
s2 = 0.03+-0.00012595000326950015;       % PTEN mRNA synthesis
s3 = 0.04772185120737359;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.11071548320193202;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.019207389692262575;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.10970207415970426;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+36.39862786304931;        % p53 sythesis
...
p4  = 1e-10+-2.1089170075297803e-11;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+1.9994021099478588e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+-56.63573030648048;       % Rb1 dephosphorylation
...
b4 = 1e-5+5.728187535073449e-07;       % Rb1 and E2F1
