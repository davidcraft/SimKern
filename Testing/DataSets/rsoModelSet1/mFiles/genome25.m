...
s1 =0.07718227251882465;        % Wip1 mRNA synthesis
s2 = 0.03+-4.521600782015957e-05;       % PTEN mRNA synthesis
s3 = 0.08710550051500937;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.11895989459835628;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.009241609701583296;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.12755920376786742;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-9.035964066712484;        % p53 sythesis
...
p4  = 1e-10+3.2364637828548113e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+6.983667232136031e-06;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+53.692213255261905;       % Rb1 dephosphorylation
...
b4 = 1e-5+-1.1127815214746577e-06;       % Rb1 and E2F1
