...
s1 =0.06416344943885424;        % Wip1 mRNA synthesis
s2 = 0.03+0.0032668263587091605;       % PTEN mRNA synthesis
s3 = 0.1306200510414654;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.1063896498366314;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.003253519233315862;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.08563329081497782;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+35.70642634966723;        % p53 sythesis
...
p4  = 1e-10+3.2167269274038927e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+1.2322126814102413e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+-147.2110346322898;       % Rb1 dephosphorylation
...
b4 = 1e-5+3.636195398010273e-07;       % Rb1 and E2F1
