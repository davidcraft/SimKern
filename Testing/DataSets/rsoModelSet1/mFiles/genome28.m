...
s1 =0.1599927060149565;        % Wip1 mRNA synthesis
s2 = 0.03+0.01193052346470019;       % PTEN mRNA synthesis
s3 = 0.13359192051135513;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.08854496342987758;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +0.01593231605393588;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.11364325603875726;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+25.62287239744145;        % p53 sythesis
...
p4  = 1e-10+2.0865143407042253e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+1.509201250572909e-07;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+-83.59741693255044;       % Rb1 dephosphorylation
...
b4 = 1e-5+1.787186827906195e-06;       % Rb1 and E2F1
