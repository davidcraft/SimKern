...
s1 =0.16622892590964877;        % Wip1 mRNA synthesis
s2 = 0.03+-0.00209816457668359;       % PTEN mRNA synthesis
s3 = 0.28432341371936654;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.10981196291882779;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.0025243999474483365;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.10366954177632375;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-6.500199691710747;        % p53 sythesis
...
p4  = 1e-10+-6.566069662199436e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+1.246800525185563e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+-21.08370523840538;       % Rb1 dephosphorylation
...
b4 = 1e-5+7.716532287504351e-08;       % Rb1 and E2F1
