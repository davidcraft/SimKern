...
s1 =0.1325175615102632;        % Wip1 mRNA synthesis
s2 = 0.03+0.010670017277353812;       % PTEN mRNA synthesis
s3 = 0.09555268222008102;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.08586679105391012;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.02093429595295263;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.09259766217971903;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-14.575295241715203;        % p53 sythesis
...
p4  = 1e-10+-4.680194817649174e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+-3.4923488499739585e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+76.80426038266177;       % Rb1 dephosphorylation
...
b4 = 1e-5+-6.626492541517735e-07;       % Rb1 and E2F1
