...
s1 =0.149664828359057;        % Wip1 mRNA synthesis
s2 = 0.03+-0.004825645499611022;       % PTEN mRNA synthesis
s3 = 0.2652536909511487;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.1068847718218488;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +0.004500019840621323;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.11820625900355067;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+35.13575967557758;        % p53 sythesis
...
p4  = 1e-10+1.0999529021365014e-11;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+1.7906999061813863e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+-55.92594725403522;       % Rb1 dephosphorylation
...
b4 = 1e-5+-5.080535567056213e-08;       % Rb1 and E2F1
