...
s1 =0.14889894242768448;        % Wip1 mRNA synthesis
s2 = 0.03+-0.01231154684883687;       % PTEN mRNA synthesis
s3 = 0.09848479789343714;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.08629592570188366;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.011677456715264546;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.13548206373160288;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-21.914913704145544;        % p53 sythesis
...
p4  = 1e-10+5.046042715841101e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+1.9112500037342732e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+48.740116151069664;       % Rb1 dephosphorylation
...
b4 = 1e-5+8.221698200512366e-07;       % Rb1 and E2F1
