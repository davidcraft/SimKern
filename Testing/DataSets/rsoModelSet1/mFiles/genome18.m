...
s1 =-0.0025505137889206553;        % Wip1 mRNA synthesis
s2 = 0.03+0.004408120278836155;       % PTEN mRNA synthesis
s3 = -0.040728989378788605;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.09103743115985583;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +0.010448927698019122;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.09047885036883198;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-65.05916475836044;        % p53 sythesis
...
p4  = 1e-10+-2.0128428763147974e-13;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+8.555683635142899e-06;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+-84.40755762276385;       % Rb1 dephosphorylation
...
b4 = 1e-5+1.1060762780297432e-06;       % Rb1 and E2F1
