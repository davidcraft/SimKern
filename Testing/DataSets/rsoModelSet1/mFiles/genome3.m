...
s1 =-0.11419965086883085;        % Wip1 mRNA synthesis
s2 = 0.03+0.010835643958222695;       % PTEN mRNA synthesis
s3 = 0.13550427091032113;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.09260426583220914;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +0.0071712377375002115;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.10963055293186615;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-15.301340432262997;        % p53 sythesis
...
p4  = 1e-10+9.136013000584515e-13;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+2.943416154060788e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+119.75721590745653;       % Rb1 dephosphorylation
...
b4 = 1e-5+-1.3721373395310458e-06;       % Rb1 and E2F1
