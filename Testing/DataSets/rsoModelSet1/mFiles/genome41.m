...
s1 =0.15172346087292357;        % Wip1 mRNA synthesis
s2 = 0.03+0.00044421487442688405;       % PTEN mRNA synthesis
s3 = 0.21929395120624182;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.06424887630192944;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +0.0027211988168874897;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.08857096455794905;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-4.888328572684159;        % p53 sythesis
...
p4  = 1e-10+9.400065795491297e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+-2.5836983710128456e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+3.558177543679604;       % Rb1 dephosphorylation
...
b4 = 1e-5+-1.1761475541916213e-06;       % Rb1 and E2F1
