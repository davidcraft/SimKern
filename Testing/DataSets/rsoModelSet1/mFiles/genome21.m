...
s1 =0.05638989863738451;        % Wip1 mRNA synthesis
s2 = 0.03+0.007263271351841861;       % PTEN mRNA synthesis
s3 = 0.1199308418983036;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.09412870554185347;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.00398641054232933;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.11605217008614083;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-20.3675239215209;        % p53 sythesis
...
p4  = 1e-10+1.2180976261914207e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+5.609418012513098e-06;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+94.85986029309633;       % Rb1 dephosphorylation
...
b4 = 1e-5+-2.4414811198561945e-07;       % Rb1 and E2F1
