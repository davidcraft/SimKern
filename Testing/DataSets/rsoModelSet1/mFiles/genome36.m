...
s1 =0.06242582643457557;        % Wip1 mRNA synthesis
s2 = 0.03+-0.012032199387237595;       % PTEN mRNA synthesis
s3 = 0.2376670804673771;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.11029701800814033;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +0.009280372342254041;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.08086840070719722;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-53.325695629873664;        % p53 sythesis
...
p4  = 1e-10+1.4658127505497306e-11;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+-2.1672094434267377e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+20.745284162419782;       % Rb1 dephosphorylation
...
b4 = 1e-5+-6.543632355486042e-07;       % Rb1 and E2F1
