...
s1 =0.01448055270054563;        % Wip1 mRNA synthesis
s2 = 0.03+0.004376400080860859;       % PTEN mRNA synthesis
s3 = 0.2574190849378048;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.11572892398038162;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +0.013841114882089103;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.07530623614488469;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+7.599925098411982;        % p53 sythesis
...
p4  = 1e-10+-5.241368781503771e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+-1.8301502868344174e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+21.295942089598846;       % Rb1 dephosphorylation
...
b4 = 1e-5+-1.1193943984511412e-07;       % Rb1 and E2F1
