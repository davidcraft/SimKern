...
s1 =0.06038923243723105;        % Wip1 mRNA synthesis
s2 = 0.03+-0.011039657703324931;       % PTEN mRNA synthesis
s3 = 0.229267438125936;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.10642120502126719;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.001500054062182811;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.09829686166137103;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-8.74369953566284;        % p53 sythesis
...
p4  = 1e-10+1.1644600961082163e-11;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+1.1839459425854536e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+-37.02358783188429;       % Rb1 dephosphorylation
...
b4 = 1e-5+-7.43126600118015e-07;       % Rb1 and E2F1
