...
s1 =-0.03577978340689397;        % Wip1 mRNA synthesis
s2 = 0.03+0.003937228861982108;       % PTEN mRNA synthesis
s3 = 0.16950186654442206;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.10755752782698182;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +0.012630481727037332;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.07104987500837598;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+-6.837773145206433;        % p53 sythesis
...
p4  = 1e-10+-1.5601010206391245e-11;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+1.3247705172530205e-05;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+124.24193461687818;       % Rb1 dephosphorylation
...
b4 = 1e-5+-4.922113043412074e-07;       % Rb1 and E2F1
