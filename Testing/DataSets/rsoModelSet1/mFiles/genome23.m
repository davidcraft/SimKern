...
s1 =0.15693349834436032;        % Wip1 mRNA synthesis
s2 = 0.03+0.0012006904186656474;       % PTEN mRNA synthesis
s3 = 0.2692016374559786;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.09153811054384337;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.0030492616165457465;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.05800748203362729;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+20.47252339954881;        % p53 sythesis
...
p4  = 1e-10+1.2437904238973711e-11;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+-7.41014191818627e-07;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+5.360414153395359;       % Rb1 dephosphorylation
...
b4 = 1e-5+2.2140074055156908e-07;       % Rb1 and E2F1
