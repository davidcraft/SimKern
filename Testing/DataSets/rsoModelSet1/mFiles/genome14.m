...
s1 =0.010282302594296161;        % Wip1 mRNA synthesis
s2 = 0.03+-0.00428126679967018;       % PTEN mRNA synthesis
s3 = 0.05732744278585583;        % Mdm2 mRNA synthesis
s4 = 0.03;       % Bax  mRNA synthesis [BMC Syst.Biol.2013: 0.03]
s5 = 0.11397444371233319;        % p21  mRNA synthesis
...
t1 = 0.1;        % Wip1 translation
t2 = 0.1 +-0.008962442746735973;        % PTEN translation
t3 = 0.1;        % Mdm2 translation   
t4 = 0.11616642730981994;        % Bax  translation [BMC Syst.Biol.2013: 0.2]
t5 = 0.1;        % p21  translation
    
% protein synthesis    
%
%s6 = 300;        % p53 sythesis
s6 = 300+46.371556316258626;        % p53 sythesis
...
p4  = 1e-10+-2.5066932218439933e-12;     % p53 arrester phosphorylation by HIPK
...
d10 =  d3+7.747588249990943e-06;       % p53_killer spontaneous dephosphorylation of Ser15 and Ser20
d11 =  d4;       % p53_S46 dephoshorylation of Ser46 by Wip1 
d12 = 1e4+-14.47294614103511;       % Rb1 dephosphorylation
...
b4 = 1e-5+4.217440636597604e-07;       % Rb1 and E2F1
