...
timeStamp = strrep(timeStamp,'-','_');
timeStamp = strrep(timeStamp,' ','_');
% pathToMatFile = [fullfile(pathToDataFolder,['boolean_' timeStamp])];
pathToMatFile = fullfile(pathToDataFolder,'boolean');
save(pathToMatFile)

% pathToMatFileLight = fullfile(pathToDataFolder,['boolean_light_' timeStamp]);
pathToMatFileLight = fullfile(pathToDataFolder,'boolean_light');
