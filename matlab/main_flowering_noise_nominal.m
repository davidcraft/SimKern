...
f = '..\SimKernModels\Flowering\DataReadyForML\noiseExperiments\Sim1nominalSimMatrix.csv';
sm =  csvread(f);
...
timeStamp = strrep(timeStamp,'-','_');
timeStamp = strrep(timeStamp,' ','_');
pathToMatFile = fullfile(pathToDataFolder,'flowering_noise_nominal');
save(pathToMatFile)

pathToMatFileLight = fullfile(pathToDataFolder,'flowering_noise_nominal_light');
