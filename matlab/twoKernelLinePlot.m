function twoKernelLinePlot(algs,algsBad,expInfo,classificationBoolean,titleName,subplotStyleBoolean,goodKernelLabel,badKernelLabel,goodKernelLabelPos,badKernelLabelPos,titlePos)
myFontsize = 12;
myLinewidth = 3;
...
text(badKernelLabelPos(1),badKernelLabelPos(2),badKernelLabel,'Color',myGreen,...
    'FontUnits','points',...
    'Interpreter','latex',...
    'FontWeight','normal',...
...
text(goodKernelLabelPos(1),goodKernelLabelPos(2),goodKernelLabel,'Color',myGreen,...
    'FontUnits','points',...
    'Interpreter','latex',...
    'FontWeight','normal',...
    'FontSize',2/3 * myFontsize,...
