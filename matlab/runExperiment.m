function [linSvm,rbfSvm,rf,ckSvm] = runExperiment(unstandardizedFeatures,classes,sm,splitRatios,classificationBoolean,subsamplingRatios,categoricalIndices)
...
%         linSvm = []; % used when commenting linSvm
        % rbf SVM
