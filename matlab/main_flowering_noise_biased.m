...
timeStamp = strrep(timeStamp,'-','_');
timeStamp = strrep(timeStamp,' ','_');
pathToMatFile = fullfile(pathToDataFolder,'flowering_noise_biased');
save(pathToMatFile)

pathToMatFileLight = fullfile(pathToDataFolder,'flowering_noise_biased_light');
