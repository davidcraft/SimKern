...
for i_m = 1:numel(mValues)
    for i_maxSplits = 1:numel(maxSplitsValues)
        ...
        rfModel{i_m,i_maxSplits} = TreeBagger(numTrees,trainData.features,trainData.classes,'Method','regression', ...
        ...
        [rSquared(i_m,i_maxSplits)] = computeRSquared(validationData.classes,predictions{i_m,i_maxSplits});
    end
end
