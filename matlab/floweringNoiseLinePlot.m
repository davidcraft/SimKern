function floweringNoiseLinePlot(algs,algsBad,algsNominal,algsBiased,expInfo,classificationBoolean,titleName,subplotStyleBoolean,linePlotLabels)
myFontsize = 12;
myLinewidth = 3;
...
%% add model name
if subplotStyleBoolean
    [myX,myY] = axxy2figxy(gca,50,0.45);
else
