function [bestModel,bestM,bestMaxSplits,bestRSquared,trainPredictions,validationPredictions] = tuneCkRfRegressionHyperparameters(trainData,validationData,mValues,maxSplitsValues,categoricalIndices,numeroTrees)
numCategories = 25;
