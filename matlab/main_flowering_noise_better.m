...
timeStamp = strrep(timeStamp,'-','_');
timeStamp = strrep(timeStamp,' ','_');
pathToMatFile = fullfile(pathToDataFolder,'flowering_noise_better');
save(pathToMatFile)

pathToMatFileLight = fullfile(pathToDataFolder,'flowering_noise_better_light');
